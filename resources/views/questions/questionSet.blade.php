        ...
        <div class="shadow p-3 mb-5 bg-white rounded">
            ...
            @endif
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <div class="alert alert-info alert-dismissible fade show">
                            <strong>Info!</strong> Total number of questions has to be at least 5.
                ...
                @if($errors->has('no_of_questions'))
                    <div class="alert alert-danger mt-2">{{ $errors->first('no_of_questions') }}</div>
                @endif
                <div class="form-group mb-3">
                    <label class="control-label col-sm-3" for="topics"><b>Topic</b></label>
                    <div class="alert alert-info alert-dismissible fade show">
                        <strong>Info!</strong> Topic weightage refers to the probability of it's occurance. <br>
                        More the weightage, more the probability of it's occurance. <br>
                        It can range from 1-100
                        <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                    </div>
                    <div class="row" id="container">
                        ...
                        <div class="col-sm-4">
                            <input type="number" class="form-control weightage" min="1" max="100"placeholder="Enter the weightage in percent of the topic" name="weightage[]">
                        </div>
                ...
                <div class="alert alert-danger mt-2">{{ $errors->first('topics') }}</div>
            @endif
